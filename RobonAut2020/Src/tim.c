...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB1     ------> TIM3_CH4 
    */
    GPIO_InitStruct.Pin = REM_CH1_Pin|REM_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = REM_CH3_Pin|REM_CH4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2 
    */
    GPIO_InitStruct.Pin = SERVO_FRONT_Pin|SERVO_REAR_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4 
    */
    HAL_GPIO_DeInit(GPIOA, REM_CH1_Pin|REM_CH2_Pin);

    HAL_GPIO_DeInit(GPIOB, REM_CH3_Pin|REM_CH4_Pin);
